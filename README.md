...
Using the set of weights obtained at iteration 860, this network achieved a testing accuracy of 79.24% 
on the holdout dataset:

```Accuracy using model "CNN_860_256_0.0005" = 79.24%``` 

## Potential Improvements
This testing accuracy is reasonable considering the implicit limitations. Only 74 students were used to train the data. We don't expect our model to be able to perfectly predict on unseen data given this tremendous lack of training and validation data. 
